...
export default function Blog() {
  ...
  const blogPosts = [
    {
      ...
      snippet:
        "Deep dive into our custom control system architecture and implementation for competitive robotics.",
      date: "January 2025",
    ...
    },
    {
      ...
      snippet:
        "How we approached the 2024 Rival Robotics Game and a Breakdown of our Robot.",
      date: "December 2024",
      readTime: "8 min read",
      category: "Strategy",
      link: "/blog/dash",
  ...
  const avgReadTime = Math.round(
    blogPosts.reduce((acc, post) => acc + parseInt(post.readTime), 0) /
      totalPosts
  );
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Insights from our engineering journey, technical deep-dives, and
            competition strategies. Follow our progress and learn from our
            innovations.
          </p>
        </div>
